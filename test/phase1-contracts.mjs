...
test('checked-in root and web generated bundles, type facades, and validators remain converged', async () => {
  ...
  assert.equal(webValidator,
    `// Generated by scripts/generate-contracts.mjs from src/contracts/validate.ts. Do not edit by hand.\n${rootValidator
...
test('every canonical product contract accepts its valid bounded vector', () => {
  assert.equal(validVectors.size, manifest.schemas.length - 1, 'all product schemas except common definitions need a valid vector');
