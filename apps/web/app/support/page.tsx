...
export default function SupportPage() {
  return (
    <TrustPage
      ...
      intro="SkillMap has a locally validated free-account flow that may run as an unlisted private hosted alpha, but no public production incident desk or response-time SLA. A useful report identifies the exact package, deployment receipt, and local state without sending private prompts, skill bodies, paths, credentials, or workspace artifacts."
    >
      <TrustSection
