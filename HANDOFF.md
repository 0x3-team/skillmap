...
Current dual-remote `main`: `5b9fb6e49ee3fcbcfc63336c810cbb1cc3bff93a`
Current dual-remote tree: `8d74d820235657a0060bcca7b514392c073bb3b1`
Historical accepted go-to-market/dual-control candidate: `413d8759e244005406280cd8d7c2fe2ec01b84bf`
Historical go-to-market/dual-control merge: `8bb2b1d25befeb53e13d0e05a6934dacc9d45cd7`
Historical accepted product-code tree: `00273fce90c0294f4f3aea2407d4ba0c65aec1f9`
Current status: GitHub and protected Gitea `main` both resolve to the later documentation/release-receipt commit `5b9fb6e49ee3fcbcfc63336c810cbb1cc3bff93a` and tree `8d74d820235657a0060bcca7b514392c073bb3b1`. Gitea runs `75` through `77` passed that anchor. GitHub workflow run `29320562416` failed before any job steps because hosted-runner allowance was unavailable, so exact-current GitHub acceptance remains open. The last exact remotely accepted product-code receipt remains candidate `413d8759e244005406280cd8d7c2fe2ec01b84bf` and merge `8bb2b1d25befeb53e13d0e05a6934dacc9d45cd7` with tree `00273fce90c0294f4f3aea2407d4ba0c65aec1f9`: Gitea candidate run ID `70` (UI run `53`) passed, scoped GitHub hosted-web job `87033792983` passed all fifteen steps in the one-shot self-hosted hosted-web scope, and post-merge `main` run ID `73` (UI `56`) passed. That historical receipt is retained in the append-only release-ledger product row; it is not the current remote head. The present `codex/product-checkpoint` remediation is local, uncommitted, unpushed, and not remotely accepted. The product is not deployed or verified live, and no remote database/web project, OAuth path, backup destination, worker schedule, domain, public indexing, or open-user launch is claimed. Launch remains `NO-GO`.

Current continuation boundary: use `5b9fb6e49ee3fcbcfc63336c810cbb1cc3bff93a` and tree `8d74d820235657a0060bcca7b514392c073bb3b1` as the exact remote source anchor. The recorded scoped remote product-code evidence covers only historical candidate `413d8759e244005406280cd8d7c2fe2ec01b84bf` and tree `00273fce90c0294f4f3aea2407d4ba0c65aec1f9`; every later product change, including the current checkpoint remediation, needs a new exact candidate, CI, merge, and release-ledger receipt. The raw generated Supabase types remain byte-exact for schema parity, and the web application uses a narrow override for nullable return fields from the three operator `RETURNS TABLE` RPCs.

Current source continuation: opaque binary/non-UTF-8 source is an audit and grade hard gate; report intake requires current publisher authorization; literal visitor and submitter acquisition paths expose recorded freshness without inventing a current verdict; and five consequential operator RPCs require an exact short-lived approval plus execution by a distinct role-scoped operator. The local checkpoint additionally pins worker/audit/grade evidence authority and closes report, accessibility, production-seed, metadata, CI-source, and release-truth gaps. Those local changes do not yet have candidate, remote-CI, merge, or protected-sync receipts. Nothing is deployed or verified live.
...
The historical baseline and go-to-market candidate above passed their recorded CI scopes. Current remote `main` is `5b9fb6e49ee3fcbcfc63336c810cbb1cc3bff93a`; its exact-current GitHub authority gate remains open, and the present checkpoint patch is local only. The free-public-alpha source remains experimental because no remote database/web environment, live OAuth path, restore/rollback exercise, publisher-authorized receipt-backed corpus publication, or external pilot has been accepted.
...
- Cross-browser, accessibility, deterministic visual-diff, performance-budget, privacy, failure, migration, and clean-consumer-install test lanes. Gitea covers root/web quality plus restored database/RLS/type authority; GitHub contains a separate complete disposable hosted-browser job for API, Auth, submission, report, and evidence. Candidate `413d8759e244005406280cd8d7c2fe2ec01b84bf` passed Gitea run ID `70` (UI `53`) and GitHub one-shot self-hosted hosted-web job `87033792983`; the identical tree was merged as `main` commit `8bb2b1d25befeb53e13d0e05a6934dacc9d45cd7`, retained through Gitea protected sync PR `#7`, and passed sync-branch run ID `71` (UI `54`), PR run ID `72` (UI `55`), and post-merge `main` run ID `73` (UI `56`). The GitHub acceptance remains scoped to that job rather than the red overall workflow.
